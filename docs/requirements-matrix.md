...
| Accordions reopen after operator closes them. | Missing view-state policy | Per-group edge-event auto-open policy controls reopen behavior. | Future implementation gate: manual collapse persistence tests |
